...
label_act <- tags$div(
  class="box",
  tags$img(src="http://usr.ntpu.edu.tw/lyadmin/pages/uploads/image/cus1_ttahpdwouf.jpg"),
  tags$div(class="label","活動")
)
```
...
label_act <- tags$div(
  class="box",
  tags$img(src="http://usr.ntpu.edu.tw/lyadmin/pages/uploads/image/cus1_bisyzh65si.jpg"),
  tags$div(class="label","活動")
)
```
